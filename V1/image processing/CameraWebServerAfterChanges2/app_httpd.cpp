...
void initializePhotoCount() {
    ...
    photoCount = maxNumber + 1;

    Serial.print("Starting photo count at: ");
...
static esp_err_t capture_handler(httpd_req_t *req) {
  ...
  char path[32];
  snprintf(path, sizeof(path), "/photo%d.jpg", photoCount);
